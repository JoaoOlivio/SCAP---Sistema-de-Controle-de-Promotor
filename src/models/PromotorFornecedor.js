...
class PromotorFornecedor extends Model {
    ...
    static associate(models) {
        ...
        this.belongsTo(models.promotor, { foreignKey: { unique: 'compositeIndex', name: 'promotorId' , allowNull: false, validate: {notNull: {msg: 'Promotor não pode ser nulo!'}}}, as: 'promotor' });
        this.belongsTo(models.fornecedor, { foreignKey: { unique: 'compositeIndex', name: 'fornecedorId' , allowNull: false, validate: {notNull: {msg: 'Fornecedor não pode ser nulo!'}}}, as: 'fornecedor' });
    }
